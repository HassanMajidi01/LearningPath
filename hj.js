...
let questions = [
  {
    correctOrder: ["حوله ی", "حمّام", "را", "دور", "خودش", "پیچید"],
    pieces: ["حمّام", "را", "دور", "خودش", "پیچید", "حوله ی"]
  },
  {
    correctOrder: [ "محمّد", "به", "خانه", "می رود"],
    pieces: ["به", "خانه", "می رود", "محمّد"]
  },
  {
    correctOrder: ["مادر", "با", "من", "صحبت", "می کند"],
    pieces: ["با", "من", "صحبت", "می کند", "مادر"]
  },
  {
    correctOrder: ["ثریّا", "حیوانات", "را", "دوست", "دارد"],
    pieces: ["حیوانات", "را", "دوست", "دارد", "ثریّا"]
  },
  {
    correctOrder: ["حامد", "هر", "روز", "ورزش", "می کند"],
    pieces: ["هر", "روز", "ورزش", "می کند", "حامد"]
  },
  {
    correctOrder: ["هاله", "صیحانه یِ", "دلپذیری", "خورد"],
    pieces: ["صیحانه یِ", "دلپذیری", "خورد", "هاله"]
  },
  {
    correctOrder: ["زهرا","صبحِ", "زود", "از", "خواب", "بیدار", "می شود"],
    pieces: ["صبحِ", "زود", "از", "خواب", "بیدار", "می شود", "زهرا"]
  },
  {
    correctOrder: ["سعید", "به", "سمتِ", "مدرسه", "حرکت", "می کند"],
    pieces: ["به", "سمتِ", "مدرسه", "حرکت", "می کند", "سعید"]
  },
  {
    correctOrder: ["شهلا", "صورتش", "را", "با", "حوله", "خشک", "می کند"],
    pieces: ["صورتش", "حوله", "را", "شهلا", "با", "خشک", "می کند"]
  },
  {
    correctOrder: ["ما", "از", "دیدن","یک", "تمساح", "می ترسیم"],
    pieces: ["تمساح", "می ترسیم", "ما", "از", "دیدن", "یک"]
  },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const wordQuestions = [
    { question: 'کدام کلمه درست است؟', options: ['اهساس', 'احساس', 'احصاص'], correct: 'احساس' },
    { question: 'کدام کلمه درست است؟', options: ['ناراهت', 'نارت', 'ناراحت'], correct: 'ناراحت' },
    { question: 'کدام کلمه درست است؟', options: ['خوش هال', 'خوش حال'], correct: 'خوش حال' },
    { question: 'کدام کلمه درست است؟', options: ['دهان', 'دحان'], correct: 'دهان' },
    { question: 'کدام کلمه درست است؟', options: ['حالا', 'هالا'], correct: 'حالا' },
    { question: 'کدام کلمه درست است؟', options: ['زهرا', 'زحرا', 'زرا'], correct: 'زهرا' },
    { question: 'کدام کلمه درست است؟', options: ['امتحان', 'امتهان'], correct: 'امتحان' },
    { question: 'کدام کلمه درست است؟', options: ['هفت', 'حفت'], correct: 'هفت' },
    { question: 'کدام کلمه درست است؟', options: [ 'حسین', 'هسین'], correct: 'حسین' },
    { question: 'کدام کلمه درست است؟', options: [ 'صبح', 'صبه', 'سبح'], correct: 'صبح' },
  ];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const words = [
    { word: "ساحل", audio: "audio/sahel.mp3" },
    { word: "صحرا", audio: "audio/sahra.mp3" },
    { word: "استراحت", audio: "audio/esterahat.mp3" },
    { word: "حلوا", audio: "audio/hlva.mp3" },
    { word: "احترام", audio: "audio/ehteram.mp3" },
    { word: "زحمت", audio: "audio/zahmat.mp3" },
    { word: "حلزون", audio: "audio/halazon.mp3" },
    { word: "محکم", audio: "audio/mohkam.mp3" },
  ];
