...
let questions = [
  {
    correctOrder: ["در", "حوض", "کوچک", "پارک", "ماهی های", "قرمز", "زیبا", "شنا", "می کنند"],
    pieces: ["حوض", "کوچک", "پارک", "ماهی های", "قرمز", "زیبا", "شنا", "می کنند", "در"]
  },
  {
    correctOrder: [ "رضا", "با", "توپش", "در", "کوچه", "بازی", "می کند"],
    pieces: ["با", "توپش", "در", "کوچه", "بازی", "می کند", "رضا"]
  },
  {
    correctOrder: ["مادربزرگ", "مریض", "است", "و", "در", "بیمارستان", "خوابیده"],
    pieces: ["مادربزرگ", "مریض", "است", "و", "در", "بیمارستان", "خوابیده"]
  },
  {
    correctOrder: ["در", "کلاس", "ریاضی", "با", "شمارش", "عددها", "آشنا", "می شویم"],
    pieces: ["در", "کلاس", "ریاضی", "با", "شمارش", "عددها", "آشنا", "می شویم"]
  },
  {
    correctOrder: ["همه", "دانش آموزان", "در", "کلاس", "حاضر", "هستند"],
    pieces: ["همه", "دانش آموزان", "در", "کلاس", "حاضر", "هستند"]
  },
  {
    correctOrder: ["بعضی", "از", "بچه ها", "در", "کلاس", "بسیار", "بی ادب", "هستند"],
    pieces: ["از", "بعضی", "بچه ها", "در", "کلاس", "بسیار", "بی ادب", "هستند"]
  },
  {
    correctOrder: ["پدرم","قبل", "از", "نماز", "وضو", "می", "گیرد"],
    pieces: ["قبل", "وضو", "از", "پدرم", "نماز", "می ", "گیرد"]
  },
  {
    correctOrder: ["مادربزگ", "قصّه ی", "حضرت", "سلیمان", "و", "گفتگوی", "او", "با", "پرندگان", "را", "برای", "ما", "تعریف", "کرد"],
    pieces: ["قصّه ی", "حضرت", "سلیمان", "و", "گفتگوی", "او", "با", "پرندگان", "را", "برای", "ما", "تعریف", "کرد", "مادربزگ"]
  },
  {
    correctOrder: ["مامان", "در", "کیفم", "یک", "خوراکیِ", "اضافی", "گذاشته", "است"],
    pieces: ["در", "کیفم", "یک", "خوراکیِ", "اضافی", "گذاشته", "است", "مامان"]
  },
  {
    correctOrder: ["مامان", "از", "نقّاشیم", "راضی", "نبود", "و", "به", "من", "گفت", "که", "باید", "بیشتر", "تمرین", "کنم"],
    pieces: ["به", "نقّاشیم", "از", "راضی", "نبود", "باید", "مامان", "من", "گفت", "که", "و", "بیشتر", "تمرین", "کنم"]
  },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const wordQuestions = [
    { question: 'کدام کلمه درست است؟', options: ['رازی', 'راذی', 'راضی'], correct: 'راضی' },
    { question: 'کدام کلمه درست است؟', options: ['حوض', 'حوز', 'هوض'], correct: 'حوض' },
    { question: 'کدام کلمه درست است؟', options: ['رزا', 'رضا', 'رذا'], correct: 'رضا' },
    { question: 'کدام کلمه درست است؟', options: ['مریز', 'مریذ', 'مریض'], correct: 'مریض' },
    { question: 'کدام کلمه درست است؟', options: ['ریاضی', 'ریازی', 'ریاذی'], correct: 'ریاضی' },
    { question: 'کدام کلمه درست است؟', options: ['حاضر', 'حاذر', 'حازر'], correct: 'حاضر' },
    { question: 'کدام کلمه درست است؟', options: ['بعزی', 'بعضی', 'بعزی'], correct: 'بعضی' },
    { question: 'کدام کلمه درست است؟', options: ['وزو', 'وذو', 'وضو'], correct: 'وضو' },
    { question: 'کدام کلمه درست است؟', options: [ 'حضرت', 'حزرت', 'حذرت'], correct: 'حضرت' },
    { question: 'کدام کلمه درست است؟', options: [ 'اضافی', 'ازافی', 'اذافی'], correct: 'اضافی' },
  ];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const words = [
    { word: "حوض", audio: "audio/hoz.mp3" },
    { word: "رضا", audio: "audio/reza.mp3" },
    { word: "مریض", audio: "audio/mariz.mp3" },
    { word: "ریاضی", audio: "audio/riazi.mp3" },
    { word: "حاضر", audio: "audio/hazer.mp3" },
    { word: "بعضی", audio: "audio/bazi.mp3" },
    { word: "اضافی", audio: "audio/ezafi.mp3" },
    { word: "راضی", audio: "audio/razi.mp3" },
  ];
