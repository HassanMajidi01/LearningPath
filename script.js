...
let questions = [
  ...
  {
    correctOrder: [ "تابستان","گذشته","علی", "به", "سفر", "رفت"],
    pieces: [ "سفر","به","تابستان", "رفت", "علی", "گذشته"]
  },
  {
  ...
  {
    correctOrder: ["معلم","همه یِ","دانش آموزانش", "را", "دوست", "دارد"],
    pieces: ["همه یِ","را","دارد", "دوست", "دانش آموزانش", "معلم"]
  },
  {
