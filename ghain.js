...
let questions = [
  {
    correctOrder: ["مرغابی", "در", "کنار", "دریاچه", "شنا", "می کند"],
    pieces: ["می کند", "مرغابی", "در", "کنار", "دریاچه", "شنا"]
  },
  {
    correctOrder: [ "او", "به خاطر", "خبر", "بد", "غمگین", "شد"],
    pieces: ["به خاطر", "خبر", "بد", "او", "غمگین", "شد"]
  },
  {
    correctOrder: ["جغد", "شب ها", "پرواز", "می کند"],
    pieces: ["پرواز", "می کند", "شب ها", "جغد"]
  },
  {
    correctOrder: ["مغز", "انسان", "مرکز", "کنترل", "بدن", "است"],
    pieces: ["مرکز", "کنترل", "بدن", "است", "مغز", "انسان"]
  },
  {
    correctOrder: ["بازار", "امروز", "شلوغ", "است"],
    pieces: ["شلوغ", "است", "بازار", "امروز"]
  },
  {
    correctOrder: ["مرغ", "در", "باغ", "دانه", "می خورد"],
    pieces: ["در", "دانه", "می خورد", "مرغ", "باغ"]
  },
  {
    correctOrder: ["گل", "رز", "تیغ", "دارد"],
    pieces: ["تیغ", "دارد", "گل", "رز"]
  },
  {
    correctOrder: ["صدای", "جیغ", "بلندی", "در", "باغ", "شنیدم"],
    pieces: ["صدای", "بلندی", "در", "باغ", "جیغ", "شنیدم"]
  },
  {
    correctOrder: ["کلاغ", "بال های", "سیاه", "دارد"],
    pieces: ["سیاه", "دارد", "کلاغ", "بال های"]
  },
  {
    correctOrder: ["باغبان", "درختان", "را", "آبیاری", "می کند"],
    pieces: ["آبیاری", "می کند", "باغبان", "درختان", "را"]
  },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const wordQuestions = [
    { question: 'کدام کلمه درست است؟', options: ['غاز', 'قاز', 'غاذ'], correct: 'غاز' },
    { question: 'کدام کلمه درست است؟', options: ['جوجه تیغی', 'جوجه تیقی', 'جوجه طیغی'], correct: 'جوجه تیغی' },
    { question: 'کدام کلمه درست است؟', options: ['قروب', 'غروب', 'غرب'], correct: 'غروب' },
    { question: 'کدام کلمه درست است؟', options: ['پیغمبر', 'پیقمبر', 'پیغم بر'], correct: 'پیغمبر' },
    { question: 'کدام کلمه درست است؟', options: ['قذا', 'غزا', 'غذا'], correct: 'غذا' },
    { question: 'کدام کلمه درست است؟', options: ['قنچه', 'غنچه', 'غونچه'], correct: 'غنچه' },
    { question: 'کدام کلمه درست است؟', options: ['چراق', 'چراغ', 'چرغ'], correct: 'چراغ' },
    { question: 'کدام کلمه درست است؟', options: ['غاصدک', 'قاصدک', 'عاصدک'], correct: 'قاصدک' },
    { question: 'کدام کلمه درست است؟', options: [ 'غاشغ', 'غاشق', 'قاشق'], correct: 'قاشق' },
    { question: 'کدام کلمه درست است؟', options: [ 'غایق', 'قایغ', 'قایق'], correct: 'قایق' },
  ];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const words = [
    { word: "مرغابی", audio: "audio/morghabi.mp3" },
    { word: "غمگین", audio: "audio/ghamgin.mp3" },
    { word: "جغد", audio: "audio/joghd.mp3" },
    { word: "مغز", audio: "audio/maghz.mp3" },
    { word: "شلوغ", audio: "audio/sholoogh.mp3" },
    { word: "مرغ", audio: "audio/morgh.mp3" },
    { word: "تیغ", audio: "audio/tigh.mp3" },
    { word: "جیغ", audio: "audio/jigh.mp3" },
  ];
